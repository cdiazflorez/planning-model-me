...
abstract class GetConsolidatedBacklog {
    ...
    /**
     * @return the date when the latest backlog photo was taken, or the {@code defaultDate} if
     * either the received {@code consolidations} list is empty or the latest photo date is more
     * than five minutes earlier than the {@code defaultDate}.
     * TODO Explain why the second is necessary.
     */
     ...
     * boundary.
     * TODO ask why this method is used by {@link GetBacklogMonitorDetails} only and not also by the {@link GetBacklogMonitor}.
     *
     * @param consolidations the list of consolidations of the latest backlog photos with the date
     *                       truncated to hours except the last <--- FIXME: complex assumptions is a sign of lack of proper data types. The las photo should be out of the list in another field.
