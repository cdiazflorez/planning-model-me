...
@Named
public class GetDeferralProjection extends GeneralDeferralProjection {


    public GetDeferralProjection(PlanningModelGateway planningModelGateway,
                                 GetProjectionSummary getProjectionSummary,
                                 GetSimpleDeferralProjection getSimpleDeferralProjection,
