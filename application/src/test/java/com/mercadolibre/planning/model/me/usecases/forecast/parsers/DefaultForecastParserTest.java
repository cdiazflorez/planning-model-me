...
public class DefaultForecastParserTest {
    ...
    void parseOk() {
        ...
        when(mockedSheetParser1.workflow()).thenReturn(FBM_WMS_OUTBOUND);
        ...
        when(mockedSheetParser2.workflow()).thenReturn(FBM_WMS_OUTBOUND);
        ...
        final List<ForecastSheetDto> parsedSheets =
                defaultForecastParser.parse(WAREHOUSE_ID, FBM_WMS_OUTBOUND, document);
    ...
    void sheetNotFoundShouldThrowForecastParsingException() {
        ...
        when(mockedSheetParser.workflow()).thenReturn(FBM_WMS_OUTBOUND);
