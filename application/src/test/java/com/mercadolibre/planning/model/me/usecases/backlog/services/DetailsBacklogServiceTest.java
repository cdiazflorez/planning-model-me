    ...
    Mockito.when(
        projectionGateway.getBacklogProjection(
            BacklogProjectionRequest.builder()
                ...
                .processName(List.of(ProcessName.WAVING))
                .currentBacklog(List.of(
                    new CurrentBacklog(ProcessName.WAVING, currentBacklog),
                    new CurrentBacklog(ProcessName.PICKING, 0),
                    new CurrentBacklog(ProcessName.PACKING, 0)
                ))
                .dateFrom(dateFrom)
                .dateTo(dateTo)
                .applyDeviation(true)
